                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="text-right">
                                        ...
                                        @if($chatItem->unread_messages)
                                            <span class="inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-green-100 bg-green-600 rounded-full">{{ $chatItem->unread_messages }}</span>
                                        @endif
                                    </div>
                                </div>
            ...
            @if ($contactChat || $chat)
                ...
                <div class="bg-gray-100 h-16 flex items-center px-3">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="{{ $this->active ? 'text-green-500' : 'text-red-600' }} text-xs" x-show="chat_id != typingChatId">
